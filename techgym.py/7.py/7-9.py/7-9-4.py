...
def deal_card(player):
  choice_card_number = random.randint(0, len(marks) * len(numbers) - 1)
  while cards[choice_card_number].is_dealt:
    choice_card_number = random.randint(0, len(marks) * len(numbers) - 1)
  player.cards.append( cards[choice_card_number] )
  player.total_number += cards[choice_card_number].number
  calc_ace(player)
  cards[choice_card_number].is_dealt = True
